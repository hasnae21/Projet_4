...
class Todolist extends React.Component{
    ...
    affiche=()=>{
        axios.get('http://127.0.0.1:8000/api/task/').then(res=>{this.setState({list:res.data});});
    }
    componentDidMount=()=>{
        this.affiche();
    }
    ...
    handelupdate=async(e)=>{
      ...
      await  axios.put('http://127.0.0.1:8000/api/task/'+id,this.state).then(res=>{this.affiche();
      this.state.name='';
      this.state.Date_debut='';
      this.state.Date_fin='';
      this.state.description='';
